  ...
  return (
    <>
        ...
        <div className={classes.logo}>
            <div>
                <h4 className={classes.backtopolicy} onClick={() => { navigate("/Healthpolicy");}}> ⇐ back To Policy</h4>
            </div>
            ...
            <div className={classes.companylogo2}>
                ...
                <button className={classes.backtopolicy2}  onClick={() => { navigate("/Finalhealthcompare");}} > Now you can proside</button>
