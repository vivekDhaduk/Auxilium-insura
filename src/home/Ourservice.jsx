            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-3 services-dtl">
                        ...
                        <p>we provide the Easy installments from any coprative compny</p>
                    </div>
                    <div class="col-sm-3 services-dtl">
                        <span class="ti-wallet"></span>
                        <h3>Best Insurence</h3>
                        <p>best policy wich suit's your budget and comforts</p>
                    </div>
                    <div class="col-sm-3 services-dtl">
                        <span class="fa fa-laptop"></span>
                        <h3>Online Account</h3>
                        <p>visite at the Auxilium Insura and register to find your best insurence</p>
                    </div>
                    <div class="col-sm-3 services-dtl">
                        <span class="ti-lock"></span>
                        <h3>Strongly Secure</h3>
                        <p>Auxilium Insura provide the best security to thier customers</p>
                    </div>
                    <div class="col-sm-3 services-dtl">
                        <span class="ti-book"></span>
                        <h3>Understandable Terms</h3>
                        <p>easy way to understand terms of the policy and insurence</p>
                    </div>
                </div>
            </div>
        </section>
