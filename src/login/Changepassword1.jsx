...
function Changepassword1() {
  ...
  const Submite = async()=>{
   ...
   await axios.post(`${url}/userIns/changepass`,h1).then((res)=>{
      console.log(res);
      setSub(res)
      setData({
        otp:"",
  ...
  return (
    ...
    <form className="basecont" onSubmit={OnSingup}>
        ...
        <div className="main1">
          ...
          <div className="main">
            <div className="imgcontainer1">
                <img className='pcpass1' src="../images/pcpass1.gif" alt="Avatar" class="avatar"/>
            </div>
        ...
        <button className="text" type="submit" class="submitbtn">Submit</button>
        <button  type="button" class="cancelbtn" onClick={()=>{
                       navigate('/login')}}>Cancel</button>
  </div>
